...
public class CodeGenerationVisitor implements Visitor {
  ...
  private Hashtable<String, Integer> globalStringMap = new Hashtable<String, Integer>();
  private Vector<String> globalStringTable = new Vector<String>();

  private Vector functionLiterals = new Vector();
  private Vector<Double> numberLiterals = new Vector<Double>();
  private Vector<String> stringLiterals = new Vector<String>();

  private Hashtable<Identifier, Identifier> localVariableTable = new Hashtable<Identifier, Identifier>();

  private Hashtable jumpLabels = new Hashtable();
  private Vector unresolvedJumps = new Vector();
  private Vector<String> labelSet = new Vector<String>();
  ...
  void visitWithNewLabelSet(Node node) throws CompilerException {
    Vector<String> saveLabelSet = labelSet;
...
@Override
public Expression visit(AnnotationLiteral literal) throws CompilerException {
    // TODO Auto-generated method stub
    System.out.println("visit " + literal);
    writeXop(JsFunction.XOP_ANNOTATION, getStringLiteralIndex(literal.anno.string));
    return literal;
}
}
