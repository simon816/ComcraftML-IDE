...
public class DeclarationVisitor extends TraversalVisitor {
  private Vector<ExpressionStatement> functionVector;
  private Vector<Identifier> variableVector;
  ...
  public Program visit(Program program) throws CompilerException {
    Vector<ExpressionStatement> oldFunctionVector = functionVector;

    functionVector = new Vector<ExpressionStatement>();
  ...
  public Statement visit(VariableStatement variableStatement) throws CompilerException {
    Vector<Statement> statements = new Vector<Statement>(0);
